...
#   Default (vehicle):  ./run_bench2drive_ros_ssh.sh
#   Ackermann mode:     CONTROL_MODE=ackermann ./run_bench2drive_ros_ssh.sh
#
...
MY_AGENT=/home/dellpro2/Karmishth/my_ros2_agent.py
